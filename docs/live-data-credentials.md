...
- Google Drive export: `GOOGLE_DRIVE_ACCESS_TOKEN`, `GOOGLE_DRIVE_REFRESH_TOKEN`, `GOOGLE_DRIVE_FOLDER_ID`
- Email/SMS: `SENDGRID_API_KEY`, `MAILCHIMP_API_KEY`, `TWILIO_ACCOUNT_SID`, `TWILIO_AUTH_TOKEN`
- Other marketplaces: `ETSY_CLIENT_ID`, `ETSY_CLIENT_SECRET`, `WOOCOMMERCE_CONSUMER_KEY`, `WOOCOMMERCE_CONSUMER_SECRET`
